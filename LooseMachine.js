...
(function(){
    ...
    this.extendOptions = function( defaults, newOptions ) {
        var option,options = {};
        // Append defaults
    ...
    this.Action = function(id, options) {
        ...
        this.addState = function (state) {
            ...
            if (typeof state == "undefined" || !(state instanceof self.ActionState)) throw Error("Invalid state provided");
        ...
        this.getState = function (id) {
            ...
            if (id instanceof self.ActionState) return id; // Already an ActionState
            if (typeof id != "string") throw Error("Invalid id provided");
     ...
     */
    this.ActionState = function(id, options) {
        // Private vars
        var active = false; /* is active? */
        ...
        this.setAction = function (action) {
            if (typeof action == "undefined" || !(action instanceof self.Action)) throw new Error("Invalid actionObject provided");
            actionObject = action;
        };
        ...
        this.runHandler = function (handlerId, parameter, actionState) {
            if (typeof actionState == "object" && actionState instanceof self.ActionState) {
        ...
        this.runHandlerAs = function (actionState, handlerId, parameter) {
            if (typeof parameter === "undefined") parameter = undefined;
            if (typeof actionState === "undefined" || !(actionState instanceof self.ActionState)) throw new Error("Invalid actionState provided");
